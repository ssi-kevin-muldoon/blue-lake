  ...
  return (
    <div className="App">
      <header className="App-header">
        ...
        <p>
          <AXButton type={type.primary} onClick={returnFalse} icon={iconUpload} iconTrailing={iconUpload} disabled={disabled}>Primary stess test with longer text</AXButton>
          ...
          <AXButton type={type.tertiary} onClick={returnFalse} icon={iconUpload} disabled={disabled}>Tertiary with extra text here</AXButton>
          ...
          <AXButton type={type.link} onClick={returnFalse} icon={iconUpload} disabled={disabled}>Link stess test with longer text</AXButton>
        </p>
      </header>
      <p>
        ...
        <AXButton type={type.warning} onClick={returnFalse} icon={iconUpload} disabled={disabled}>Warning stess test with longer text</AXButton>
        <AXButton type={type.danger} onClick={returnFalse} icon={iconUpload} disabled={disabled}>Danger stess test with longer text</AXButton>
        <AXButton type={type.link} onClick={returnFalse} icon={iconUpload} disabled={disabled}>Link </AXButton>
